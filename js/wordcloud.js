var resourceId = "6bdb2280-e334-4339-8078-f806d8fce085";
...
var dateCalc = moment('10-11-2014').subtract(12, 'M').format("YYYY-MM-DD");
var permitDescQuery = "SELECT \"Description\" from \"resource_id\" WHERE \"AppliedDate\" >= \'" + dateCalc + "\'";
...
requestJSON(permitDesc, function(json) {
    ...
    descArray.forEach(function(d) {
      if (!isNumeric(d) && !matches(d.toUpperCase(), "AND", "OF", "TO", "", "&", "ON", "-", "THE", "IN", "BE", "FOR", "A")) {
        var descObject = {}
